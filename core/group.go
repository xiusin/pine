...
// 添加路由, 内部函数
func (r *RouteGroup) AddRoute(method, path string, handle Handler, mws ...Handler) *Route {
	//替换正则匹配映射
...
// 自动注册映射处理函数的http请求方法
func (r *RouteGroup) autoMatchHttpMethod(path string, handle Handler) {
...
// 大写字母变分隔符
func (r *RouteGroup) upperCharToUnderLine(path string) string {
...
func (r *RouteGroup) POST(path string, handle Handler, mws ...Handler) *Route {
	return r.AddRoute(http.MethodPost, path, handle, mws...)
}

func (r *RouteGroup) PUT(path string, handle Handler, mws ...Handler) *Route {
	return r.AddRoute(http.MethodPut, path, handle, mws...)
}

func (r *RouteGroup) HEAD(path string, handle Handler, mws ...Handler) *Route {
	return r.AddRoute(http.MethodHead, path, handle, mws...)
}

func (r *RouteGroup) DELETE(path string, handle Handler, mws ...Handler) *Route {
	return r.AddRoute(http.MethodDelete, path, handle, mws...)
}

func (r *RouteGroup) ANY(path string, handle Handler, mws ...Handler) {
