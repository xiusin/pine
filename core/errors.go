        ...
        <div class="__BtrD__row __BtrD__contents">
            <div class="__BtrD__col-md-3 __BtrD__attr __BtrD__left">
                <div class="__BtrD__content-nav" id="cont-nav">
                    <div class="__BtrD__top-tog __BtrD__active" id="__BtrD__function">Debug Trace List</div>
                </div>
...
<script>
	...
	var editor = initEditor(` + strconv.Itoa(e.firstLine) + `);
    ...
    for (var i = 0; i< ls.length; i++) {
        ls[i].onclick = function (i) {
            return function () {
                ...
                editor = initEditor(Number(ls[i].dataset.fline) + 1)
            }
        }(i)
    }
...
func (e *ErrHandler) ShowTraceInfo(msg string) string {
	...
	for i := 0; i < l; i += 2 {
		...
		str += `<div class="__BtrD__loop-tog __BtrD__l-parent" data-id="proc-` +
			...
			path[0] + `" data-class="trigger_error" data-fline="` + strconv.Itoa(firstLine) + `" data-line="` +
