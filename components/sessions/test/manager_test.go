...
import (
	"github.com/xiusin/router/components/cache/adapters/memory"
	"github.com/xiusin/router/components/sessions"
	"github.com/xiusin/router/components/sessions/store/adapter/cache"
	"github.com/xiusin/router/components/sessions/store/adapter/file"
	"io/ioutil"
	"math/rand"
	"net/http"
	"net/http/httptest"
...
func TestNew(t *testing.T) {
	...
	case 1:
		...
		mgr = sessions.New(file.NewStore(&file.Config{
	...
	case 0:
		...
		mgr = sessions.New(cache.NewStore(&cache.Config{Cache: memory.New(memory.Option{})}))
	}
